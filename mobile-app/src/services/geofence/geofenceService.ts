...
export const geofenceService = {
  async getGeofences(): Promise<Geofence[]> {
    ...
    return (data || []).map(item => ({
      ...
      centerLatitude: parseFloat(item.center_latitude),
      centerLongitude: parseFloat(item.center_longitude),
  ...
  async getGeofence(id: string): Promise<Geofence> {
    ...
    return {
      ...
      centerLatitude: parseFloat(data.center_latitude),
      centerLongitude: parseFloat(data.center_longitude),
  ...
  async getLinkedGeofences(trackerId: string): Promise<(Geofence & { alertOnEnter: boolean, alertOnExit: boolean })[]> {
    ...
    return (data || []).map(item => ({
      ...
      centerLatitude: parseFloat(item.geofences.center_latitude),
      centerLongitude: parseFloat(item.geofences.center_longitude),
      radius: parseFloat(item.geofences.radius),
